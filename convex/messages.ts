...
export const sendTextMessage = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    // Normalize the tokenIdentifier by removing 'https://'
    const normalizedTokenIdentifier = identity.tokenIdentifier.replace(
      /^https?:\/\//,
      ""
    );
    ...
    const user = await ctx.db
      ...
      .withIndex("by_tokenIdentifier", (q) =>
        q.eq("tokenIdentifier", normalizedTokenIdentifier)
      )
      .unique();
